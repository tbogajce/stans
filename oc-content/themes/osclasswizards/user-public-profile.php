...
<div class="row">
  <div class="col-lg-3 col-md-4">
    <div class="user-card">
      ...
      <ul id="user_data">
        <li class="name">
          <h3><i class="fas fa-user"></i> <?php echo osc_user_name(); ?></h3>
        </li>
        <?php if( osc_user_website() !== '' ) { ?>
        <li class="website"><i class="fas fa-link"></i> <strong><a target="_blank" href="<?php echo osc_user_website(); ?>"><?php echo osc_user_website(); ?></a></strong></li>
        <?php } ?>
        <?php if( $address !== '' ) { ?>
        <li class="adress"> <i class="fas fa-map-marker"></i> <strong><?php _e('Address', OSCLASSWIZARDS_THEME_FOLDER);?>:</strong><br><?php echo $address; ?></li>
        <?php } ?>
        <?php if( $location !== '' ) { ?>
        <li class="location"><i class="fas fa-location-arrow"></i> <strong><?php _e('Location', OSCLASSWIZARDS_THEME_FOLDER);?>:</strong><br><?php echo  $location; ?></li>
        <?php } ?>
      </ul>
    </div>
