        ...
        <div class="col-sm-8 col-md-8">
          <div class="info">
            <div class="detail_info">
              ...
              <div class="attribute_list"> <span class="category"><i class="<?php echo osclasswizards_category_icon( osc_item_category_id() ); ?>"></i> <?php echo osc_item_category() ; ?></span> <span class="location"><i class="fas fa-map-marker"></i> <?php echo osc_item_city(); ?>
                <?php if( osc_item_region()!='' ) { ?>
                (<?php echo osc_item_region(); ?>)
                <?php } ?>
                </span> <span class="date"> <i class="fas fa-calendar"></i> <?php echo osc_format_date(osc_item_pub_date()); ?> </span>
        ...
        <div class="col-sm-8 col-md-8">
          <div class="info">
            <div class="detail_info">
              ...
              <div class="attribute_list"> <span class="category"><i class="<?php echo osclasswizards_category_icon( osc_premium_category_id() ); ?>"></i><?php echo osc_premium_category() ; ?></span> <span class="location"><i class="fas fa-map-marker"></i> <?php echo osc_premium_city(); ?>
                <?php if(osc_premium_region()!='') { ?>
                (<?php echo osc_premium_region(); ?>)
                <?php } ?>
                </span> <span class="date"> <i class="fas fa-calendar"></i> <?php echo osc_format_date(osc_premium_pub_date()); ?> </span>
                <?php if( osc_price_enabled_at_items() ) { ?>
