...
<div class="toolbars toolbar"><span class="sorting"> <a href="<?php echo osc_user_public_profile_url( Params::getParam('id') ); ?>?sShowAs=list" class="list-button <?php if(osclasswizards_show_as()=='list')echo "active"; ?>" data-class-toggle="listing-grid" data-destination="#listing-card-list"><span> <i class="fas fa-th-list"></i> </span></a> <a href="<?php echo osc_user_public_profile_url( Params::getParam('id') ); ?>?sShowAs=gallery" class="grid-button <?php if(osclasswizards_show_as()=='gallery') echo "active"; ?>" data-class-toggle="listing-grid" data-destination="#listing-card-list"><span> <i class="fas fa-th-large"></i></span></a> </span> </div>
...
?>
  ...
  <li class="listing-card col-lg-4 col-md-6 <?php if(osc_item_is_premium()){ echo ' premium'; } ?>">
    <div class="figure">
      <figure>
      ...
      <?php } ?>
      <?php } ?>
      <span class="ribbon"> <i class="fas fa-star"></i> </span>
      <article>
      <span class="category"><i class="<?php echo osclasswizards_category_icon( osc_item_category_id() ); ?>"></i> <?php echo osc_item_category() ; ?></span> <span class="location"><i class="fas fa-map-marker"></i><?php echo osc_item_city(); ?>
      <?php if( osc_item_region()!='' ) { ?>
      (<?php echo osc_item_region(); ?>)
      <?php } ?>
      </span> <span class="date"> <i class="fas fa-calendar"></i> <?php echo osc_format_date(osc_item_pub_date()); ?> </span> </div>
    </figure>
</div>
<div class="listing-attr">
  ...
  <article> <span class="category"><i class="<?php echo osclasswizards_category_icon( osc_item_category_id() ); ?>"></i> <?php echo osc_item_category() ; ?></span> <span class="location"><i class="fas fa-map-marker"></i><?php echo osc_item_city(); ?>
    <?php if( osc_item_region()!='' ) { ?>
    (<?php echo osc_item_region(); ?>)
    <?php } ?>
    </span> <span class="date"> <i class="fas fa-calendar"></i> <?php echo osc_format_date(osc_item_pub_date()); ?> </span> </article>
...
<?php
	...
	?>
<?php $size = explode('x', osc_thumbnail_dimensions()); ?>
<li class="listing-card premium col-lg-4 col-md-6">
  <article class="loop_premium">
    ...
    <div class="listing-attr">
      ...
      <article> <span class="category"><i class="<?php echo osclasswizards_category_icon( osc_premium_category_id() ); ?>"></i><?php echo osc_premium_category() ; ?></span> <span class="location"><i class="fas fa-map-marker"></i><?php echo osc_premium_city(); ?>
        <?php if(osc_premium_region()!='') { ?>
        (<?php echo osc_premium_region(); ?>)
        <?php } ?>
        </span> <span class="date"> <i class="fas fa-calendar"></i> <?php echo osc_format_date(osc_premium_pub_date()); ?> </span> </article>
      <?php if( osc_price_enabled_at_items() ) { ?>
